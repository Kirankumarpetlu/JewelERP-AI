...
from services.firestore_admin import initialize_firestore_admin, is_firestore_admin_ready
...
async def api_status():
    ...
    return {
        ...
        "firestore_admin": "connected" if is_firestore_admin_ready() else "not_configured",
        "collections": {
            "orders": order_count,
